...
if (!class_exists('Inwave_Portfolio_Slider')) {
    ...
    class Inwave_Portfolio_Slider extends Inwave_Shortcode
    {
        ...
        {
            global $wpdb;
            $categories = $wpdb->get_results('SELECT a.name, a.term_id FROM ' . $wpdb->prefix . 'terms AS a INNER JOIN ' . $wpdb->prefix . 'term_taxonomy AS b ON a.term_id = b.term_id WHERE b.taxonomy=\'iwp_category\'');
            $newCategories = array();
